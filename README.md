...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ggxx9oe.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ggxx9oe.containers.anotherwebservice.com/
...
```
git clone git@github.com:idkhow2type/container-ggxx9oe.git
cd container-ggxx9oe
```
...
```
docker attach container-ggxx9oe
```
